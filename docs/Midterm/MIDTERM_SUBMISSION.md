...
| Vite Setup | Issue #28(https://github.com/CapstoneDesign-Spring2026-UlsanCollege/campusMarketPlace/issues/24) — Vite frontend environment configured and merged to main |
| Setting up Backend | Issue #25(https://github.com/CapstoneDesign-Spring2026-UlsanCollege/campusMarketPlace/issues/28) — Setting up Backend Flask |
| Add Email Verification | Issue #27(https://github.com/CapstoneDesign-Spring2026-UlsanCollege/campusMarketPlace/issues/27) - Full email verification flow so only verified accounts can access protected features |
| Github Pages Deployment |commit [2a6bb879aeaed7a7cf0d4d3236babf545c029e71](https://github.com/CapstoneDesign-Spring2026-UlsanCollege/campusMarketPlace/commit/2a6bb879aeaed7a7cf0d4d3236babf545c029e71) |
| Backend | Flask3  [app.py](https://github.com/CapstoneDesign-Spring2026-UlsanCollege/campusMarketPlace/blob/main/app.py)  |
| Commit `[a1b2c3d]` | Fix root dev scripts and GitHub Pages deployment |
| Commit `[e4f5g6h]` | Connect signup page on button |
| GitHub Actions CI  | [main.yml](https://github.com/CapstoneDesign-Spring2026-UlsanCollege/campusMarketPlace/blob/main/.github/workflows/main.yml) Vite build + deploy workflow active on every push to main |
...
- **Issues with owners:** Issue #28 (Backend Setup — Ananda), Issue #25 (Setup Vite — Aayuska), Issue #27 (Email Verification FLow - Gayatri)
